...
@Component({
  selector: 'app-hyperlipemia',
  templateUrl: './hyperlipemia.component.html',
  styleUrls: ['./hyperlipemia.component.less']
})
export class HyperlipemiaComponent implements OnInit {
